...
def next_move(posx, posy, board):
    ...
    if ds == []:
        ...
        for d in os:
            ...
            os_distance[d] = squard
        print(sorted(os_distance, key=lambda x: os_distance[x]))
        d = sorted(os_distance, key=lambda x: os_distance[x])[0]
        print(d)
        steps_results = {}
...
if __name__ == "__main__":
    ...
    #print(board)
    pos = [1, 1]
    board = [['-', '-', '-', 'o', 'o'], ['-', 'b', '-', 'o', 'o'], ['-', '-', '-', 'o', 'o'], ['o', 'o', 'o', 'o', 'o'], ['o', 'o', 'o', 'o', 'o']]
    for i in board:
        print(i)
